...
FLAGSS << "-a saturate"
FLAGSS << "-a saturate -r"
FLAGSS << "-a counting -b 0"
FLAGSS << "-a counting -b 0 -r"
FLAGSS << "-a counting -b 1"
FLAGSS << "-a counting -b 1 -r"
FLAGSS << "-a counting -b 2"
FLAGSS << "-a counting -b 2 -r"
FLAGSS << "-a counting -b 3"
FLAGSS << "-a counting -b 3 -r"
FLAGSS << "-a counting -b 4"
FLAGSS << "-a counting -b 4 -r"
FLAGSS << "-a symbolic"
FLAGSS << "-a symbolic -c"
FLAGSS << "-a symbolic -i"
FLAGSS << "-a symbolic -r"
FLAGSS << "-a symbolic -i -r"
FLAGSS << "-a enumerate"
FLAGSS << "-a enumerate -c"
FLAGSS << "-a enumerate -r"
